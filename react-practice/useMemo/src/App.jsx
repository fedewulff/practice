import React, { memo, Profiler, useMemo, useState, useRef, useCallback } from "react";
    ...
    <div>
      ...
      <div>
        ...
        <p>
          ...
          <span>
            {" "}
            - The number of milliseconds estimating how much time it would take to re-render the entire Profile subtree without any
            optimizations. It is calculated by summing up the most recent render durations of each component in the tree. This value
            estimates a worst-case cost of rendering (e.g. the initial mount or a tree with no memoization). Compare actualDuration against
        ...
        <p>
          ...
          <span>
            {" "}
            - The time spent rendering the Profiler component and its descendant for the current update, 0 means it rendered extremely fast!
            This will be the same as the Base Duration on the first render
          </span>
        </p>
      </div>
    </div>
